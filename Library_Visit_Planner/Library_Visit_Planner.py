...
if day in ("Saturday", "Sunday"):
    ...
    print("Day type : The Start of the week. Check your reading list.")
elif day == "Friday":
    print("Day type : The Last day of the Week. Return books before the weekend.")
elif day in ("Tuesday", "Wednesday", "Thursday"):
    print("Day type : Regular school day. Plan a short library visit.")
else:
    print("Day type : Day not input is Invalid. Please check the spelling.")

if weather == "sunny" and book_due == "yes":
    print("Library tip : Great weather to return your book and borrow a new one.")

if weather == "rainy" or weather == "cloudy":
    print("Weather tip : Carry an umbrella if you are going to the library.")

if not (book_due == "yes"):
    print("Book status : No book to be returned today. You can browse new books.")

if weather == "rainy" and book_due == "yes":
    print("Best plan : Visit the library with an Umbrella and return your book on time.")
...
print("Your Library plan Complete")